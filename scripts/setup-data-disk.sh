...
: "${DATA_DISK_HOME_NAME:=Users:${DATA_HOME_USER:-nxmatic}}"
: "${DATA_DISK_LIBRARY_CACHE_NAME:=Users:${DATA_HOME_USER:-nxmatic} Library Cache}"
: "${DATA_DISK_VM_IMAGES_NAME:=Users:${DATA_HOME_USER:-nxmatic} VM Images}"
: "${DATA_DISK_BUILD_CHAINS_CACHE_NAME:=Users:${DATA_HOME_USER:-nxmatic} Build Chains Cache}"
: "${DATA_DISK_GIT_STORE_NAME:=Git Store}"
: "${DATA_DISK_GIT_BARE_STORE_NAME:=Git Bare Store}"
: "${DATA_DISK_NIX_STORE_NAME:=Nix Store}"
: "${DATA_HOME_VOLUME_PREFIX:=Users:${DATA_HOME_USER:-nxmatic}}"
